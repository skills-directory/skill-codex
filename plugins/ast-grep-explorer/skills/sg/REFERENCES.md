...
## Official
- Website & Docs: https://ast-grep.github.io/
- CLI Reference: https://ast-grep.github.io/guide/cli/
- Pattern Syntax & Rules: https://ast-grep.github.io/guide/scan/
- GitHub Repository: https://github.com/ast-grep/ast-grep

## Key Topics for This Skill
- `sg run -p` for inline structural patterns
